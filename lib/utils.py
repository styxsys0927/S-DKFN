...
def load_graphdata_channel1(graph_signal_matrix_filename, num_of_hours, num_of_days, num_of_weeks, DEVICE, batch_size, score=False, shuffle=True):
    '''
    这个是为PEMS的数据准备的函数
    ...
    :param score: merge train. val, test if used for score computation (True)
    :return:
