...
def TrainttDKFN(train_dataloader, valid_dataloader, A, K=3, num_epochs=1):
    ...
    learning_rate = 1e-3
    dkfn = tDKFN(K, torch.Tensor(A), A.shape[0], pred_size)
...
def TestttDKFN(dkfn, test_dataloader, max_speed):
